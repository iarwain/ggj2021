...
solution "ggj2021"
    ...
    configuration {"web"}
        ...
        buildoptions
        {
            "-DorxWEB_EXECUTABLE_NAME='\"LostEcho.wasm\"'",
            "-pthread"
        }
        linkoptions
        {
            "--preload-file " .. copybase .. "/build/LostEcho.obr@/",
    ...
    configuration {"web", "Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && LostEcho -b ../build/LostEcho.obr"}
        postbuildcommands {"del " .. path.translate(copybase, "\\") .. "\\build\\LostEcho.obr"}

    configuration {"web", "not Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && ./LostEcho -b ../build/LostEcho.obr"}
        postbuildcommands {"rm " .. copybase .. "/build/LostEcho.obr"}
