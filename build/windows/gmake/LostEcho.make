...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/LostEchod.exe
...
ifeq ($(config),profile64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/LostEchop.exe
...
ifeq ($(config),debugweb)
  ...
  define PRELINKCMDS
	...
	cd ../../../bin && LostEcho -b ../build/LostEcho.obr
  endef
  define POSTBUILDCMDS
	@echo Running post-build commands
	del ..\..\..\build\LostEcho.obr
  endef
endif
...
$(OBJDIR)/Card.o: ../../../src/Card.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"

$(OBJDIR)/ggj2021.o: ../../../src/ggj2021.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
